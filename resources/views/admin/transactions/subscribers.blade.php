                                                ...
                                                <table class="table table-bordered table-striped table-vcenter">
                                                    ...
                                                    @foreach($deposits as $item)
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                {{ optional($item->subscription)->name }}<br>
                                                            </td>
                                                            ...
                                                            <td >
                                                                @if($item->status == 0)
                                                                    <a href="{{ route('admin.approve_subscribers', $item->id) }}" class="btn btn-sm btn-alt-secondary js-bs-tooltip-enabled" data-bs-toggle="tooltip" title="Approve Deposit" data-bs-original-title="Approve">
                                                                        <i class="fa fa-check"></i>
                                                                    </a>
                                                                    {{--                                                    <a href="{{ route('admin.approve_deposit', $item->id) }}" class="btn btn-sm btn-success mb-1">Approve</a>--}}
                                                                @else
                                                                @endif
                                                                <form method="POST" action="{!! route('admin.deleteSubscribers', $item->id) !!}" accept-charset="UTF-8">
