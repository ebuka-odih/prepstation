...
Route::view('/why-prepstation', 'pages.about')->name('about');
Route::view('/trading-products', 'pages.trading-products')->name('trading-products');
Route::view('/platforms-and-tools', 'pages.platforms-and-tools')->name('platforms-and-tools');
